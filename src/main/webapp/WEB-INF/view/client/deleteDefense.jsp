...
<body>
    ...
    <footer class="css-1m3aned-CancelFooter earddrg3">그래도 탈퇴하시려면 아래 버튼을 눌러주세요.<br>다시 만날 날을 기다릴게요.
        <div class="css-121bqo8-CancelButtons earddrg2">
            <div class="css-or2n4s-ButtonBlock earddrg1"><button
                    class="css-cop6tv-Button-PrimaryButton-PreferButton emsidu90" OnClick="location.href='/redirect:/updateMemberProc.do'">안할래요</button></div>
            <div class="css-or2n4s-ButtonBlock earddrg1"><button
                    class="css-f1keza-Button-PrimaryButton-DispreferButton e88vrt90" OnClick="location.href='/deleteMemberProc.do'">탈퇴하기</button></div>
        </div>
    </footer>
</body>
</html>