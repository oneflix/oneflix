...
<body>
	...
	<main class="css-1jlmqqo-Main e19xg79h5">
		<section class="css-1vpi0so-Self-Self e1199ims0">
						...
						<div class="css-18xcnb7-SettingListContent e1199ims18">
							<div class="css-1epg2mh-SettingListContentRow e1199ims19">
								<div class="css-ht5cer-SubscribeStatus e1199ims26">
									<div class="css-1a5vbj5-SubscribeStatusText e1199ims27"
										id="cert">${member.cert}</div>
								</div>
							</div>
							<div class="css-1epg2mh-SettingListContentRow e1199ims19">
			...
			<form name="updateMember" action="/updateMemberProc.do" onsubmit="return validate();" method="post" id="form-change">
				<section class="css-34jiqc-Section e1199ims14">
					...
					<ul class="css-gi4296-SettingListUl e1199ims20">
						<li class="css-ar8roi-SettingList e1199ims17">
							...
							<div class="css-18xcnb7-SettingListContent e1199ims18"
								id="form-change">
								<div
									class="css-1epg2mh-SettingListContentRow e1199ims19 pre-form">
									<div class="css-av4kss-ValueTextBlock e1199ims30">${member.nick}</div>

									<div class="css-1vx1h8q-SmallButtonsBlock e1199ims24">
										<button class=" e1199ims25 css-lzf1fk-Self-SmallSettingButton e1ktu1gx01" type="button">변경</button>
									</div>
								</div>
								<div
									class="css-1epg2mh-SettingListContentRow e1199ims19 next-form">
									<div class="css-1ymlnpj-FieldBlock e1199ims8">
										<div class="css-unatsl-Self eu52ful0">
											<input name="newNick" id="newNick" placeholder="새 닉네임을 입력해주세요"
								...
								<div class="css-1epg2mh-SettingListContentRow e1199ims19 next-form">
									<div class="css-1ymlnpj-FieldBlock e1199ims8">
										<div class="css-unatsl-Self eu52ful0">
											<input name="passConfirm" id="passConfirm" placeholder="비밀번호를 입력해주세요"
												autocomplete="off" class=" css-5kai6j-StyledField eu52ful1"
												type="password" value="">
										</div>
									</div>
						...
						<li class="css-ar8roi-SettingList e1199ims17">
							...
							<div class="css-18xcnb7-SettingListContent e1199ims18">
								<div class="css-1epg2mh-SettingListContentRow e1199ims19">
									<div class="css-1ymlnpj-FieldBlock e1199ims8">
										<div class="css-unatsl-Self eu52ful0">
											<input id="pass" name="pass" placeholder="현재 비밀번호"
												autocomplete="off" class=" css-5kai6j-StyledField eu52ful1"
												type="password" value="">
										</div>
									</div>
								...
								<div class="css-1epg2mh-SettingListContentRow e1199ims19">
									<div class="css-1ymlnpj-FieldBlock e1199ims8">
										<div class="css-unatsl-Self eu52ful0">
											<input id="newPass" name="newPass" placeholder="새 비밀번호"
												autocomplete="off" class=" css-5kai6j-StyledField eu52ful1"
												type="password" value="">
										</div>
									</div>
								...
								<div class="css-1epg2mh-SettingListContentRow e1199ims19">
									<div class="css-1ymlnpj-FieldBlock e1199ims8">
										<div class="css-unatsl-Self eu52ful0">
											<input id="newPassConfirm" name="newPassConfirm"
												placeholder="새 비밀번호 확인" autocomplete="off"
												class=" css-5kai6j-StyledField eu52ful1" type="password" value="">
										</div>
									</div>
								</div>
							</div>
					...
					<div class="css-t5kw01-ChangeProfileButtonBlock e1199ims3">
						<button type="submit" class="css-1sli7is-Button-GreenButton-ChangeProfileButton e1199ims1">계정정보 저장</button>
					</div>
			</form>
		</section>
		</main>
	...
	<script type="text/javascript">
		function validate(){
		       ...
		       if(newNick.value!="") {
		           ...
		           confirm = true;
		    	   }else if(passConfirm.value != "${member.pass}"){
