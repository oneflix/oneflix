			...
			<div>
				...
				<div class="wrap-login100 p-t-20 p-b-30">
					...
					<form class="login100-form validate-form">
						...
						<div class="wrap-input100 textfield-border">
							<input class="input100" type="text" name="nick" autocomplete="off" placeholder="닉네임">
						</div>
						<div class="wrap-input100 textfield-border">
							<input class="input100" type="text" name="birth" autocomplete="off" maxlength="8"
								placeholder="생년월일 (숫자로만 8자리)">
						</div>
						<div class="wrap-input100 wrap-input100-bottom m-b-16 height">
							...
							<div class="gender-radio">
								<label>
									<input class="option-input radio" name="gender" value="F" type="radio" />여성
								</label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<label>
						...
						<div class="checkbox-container"> 
							<label class="checkbox-label">
								...
								<span class="terms" OnClick="window.open('#');">ONEFLIX 서비스 이용약관</span>에 동의합니다.
							</label>
						</div>
