	...
	<div class="wrapper">
       ...
       ====================== -->
		...
		<div class="content-wrapper">
			...
			<form action="/insertNoticeProc.mdo" class="row">
				<input type="hidden" name="helpType" value="notice"/>
				<!--editor form-->
			    <div class="editor-body" style="width: 80%; padding-left: 15%;">
			        ...
			        <div class="buttons" style="float: right; margin-top: 0; padding-bottom: 20px;">
			            ...
			            <button type="button" class="btn btn-secondary" onclick="location.href='/getNoticeListProc.mdo'">취소</button>
			        </div><!-- /.buttons -->
			    </div><!--editorbody-->
				<!-- /.wrapper -->
			</form>
