	...
	public String certMail(MemberVO vo) {
		try {
			...
			inquiry.setReplyContent("<h2><strong>계정 인증</strong></h2>\r\n" + 
					...
					"<br>" +
					"<p>" +
						"<a style=\"text-decoration: none;\" href=\"http://localhost:8080/oneflix/updateCertProc.do?email=" + vo.getEmail() + "\">" +
	...
	public String deactivateMail(MemberVO vo) {
		try {
			...
			inquiry.setReplyContent("<h2><strong>탈퇴 요청 확인 메일</strong></h2>\r\n" + 
					...
					"<br>" +
					"<p>" +
						"<a style=\"text-decoration: none;\" href=\"http://localhost:8080/oneflix/deleteMemberProc.do?email=" + vo.getEmail() + "\">" +
